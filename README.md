...
If a specific backup did not complete and you want more information, consult `/tmp/solr_backup.log` for the requeststatus and check it with the [requeststatus api call](https://lucene.apache.org/solr/guide/8_4/collections-api.html#requeststatus).
