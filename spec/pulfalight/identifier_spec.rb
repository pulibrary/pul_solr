...
describe 'all fields search for id value' do
  ...
  before(:all) do
    ...
    add_doc(mc_component_name1)   # c03575, "box 1865", "folder 1"
    add_doc(mc_component_name2)   # c03585, “box 1866”, “folder 1”
    add_doc(mc_component_name3)   # c03750, “box 1865”, “folder 2”
  end
  ...
  describe 'box numbers and folder numbers' do
    it 'Do a search with the collection ID, and container information at same time (ex: collection ID, box # or collection ID, box # folder #)' do
      response = solr_response(query_params('box 1865').merge('fl' => 'id', 'facet' => 'false'))
